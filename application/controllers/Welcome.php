...
class Welcome extends CI_Controller
{
    public function __construct()
    {
        ...
        parent::__construct();
        $this->load->model(['Common_model', 'Welcome_model', 'Admin_model']);

    }
    public $json_data = ["status" => "false", "data" => ""];
    ...
    public function index()
    {
        ...
        if ($total == 0) {
            $data['banners']      = $this->Common_model->get_record('tbl_banners', '*', ['status' => 1], 2, ['id', 'desc']);
            $data['categories']   = $this->Common_model->get_record('tbl_categories', '*', '', 1, ['id', 'asc']);
            $data['home_content'] = $home_content = $this->Common_model->get_record('tbl_home_content', '*', ['id' => 1], 2);
            $seo_tags             = [];
            ...
            if ($seg1 == "management") {
                $data['record'] = $record = $this->Common_model->get_record('tbl_management_content', '*', ['id' => 1], 2);
                $seo_tags       = [];
                if (! empty($record)) {
                ...
                $seo['seo_tags'] = $seo_tags;
                $categories      = $this->Common_model->get_record('tbl_management_categories', '*', ['status' => 1], 1, ['position', 'asc']);
                $all_categories  = [];
                if (! empty($categories)) {
                    foreach ($categories as $key => $row) {
                        $row['employees'] = $this->Common_model->get_record('tbl_management_employees', '*', ['category_id' => $row['id'], 'status' => 1], 1, ['id', 'desc']);
                        $all_categories[] = $row;
                    }
                }
                ...
                $seo['seo_tags'] = $seo_tags;
                $this->load->view('front-end-includes/header-mobile', $seo);
                $this->load->view('mobile-index', $data);
                $this->load->view('front-end-includes/footer-mobile');
            ...
            } else if ($seg1 == "get-gold-live-rate") {
                $data = $this->get_full_api();
                header('Content-Type: application/json');
                echo json_encode($data, JSON_PRETTY_PRINT);
                ...
                $seo['seo_tags'] = $seo_tags;
                $data['record']  = $record  = $this->Common_model->get_record('tbl_categories', '*', ['id' => 3], 2);
                $this->load->view($this->header, $seo);
                ...
                $seo['seo_tags'] = $seo_tags;
                $data['record']  = $record  = $this->Common_model->get_record('tbl_categories', '*', ['id' => 6], 2);
                $this->load->view($this->header, $seo);
                ...
                $seo['seo_tags']      = $seo_tags;
                $categories           = $this->Common_model->get_record('tbl_casted_gold_categories', '*', ['status' => 1], 1, ['display_order', 'asc']);
                $data['gold_mcx']     = $this->Common_model->get_record('tbl_categories', '*', ['id' => 1], 2);
                $data['api_details']  = $this->get_full_api();
                ...
                if (! empty($categories)) {
                    foreach ($categories as $key => $row) {
                        $row['products']  = $this->Common_model->get_record('tbl_casted_gold_products', '*', ['category_id' => $row['id']], 1, ['id', 'desc']);
                        $row['ads']       = $this->Common_model->get_record('tbl_casted_gold_ads', '*', ['category_id' => $row['id']], 1, ['id', 'desc']);
                        $all_categories[] = $row;
                    }
                }
                $data['categories'] = $all_categories;
                ...
                $data['home_content'] = $home_content = $this->Common_model->get_record('tbl_home_content', '*', ['id' => 1], 2);
                $data['record']       = $record       = $this->Common_model->get_record('tbl_cms_pages', '*', ['id' => 7], 2);
                $seo_tags             = [];
                if (! empty($record)) {
                ...
                if ($this->input->post('unique_code') != '') {
                    ...
                    $record          = $this->Common_model->get_record('tbl_casted_gold_users', '*', ['unique_code' => $unique_code, 'password' => $encode_password], 2);
                    if (! empty($record)) {
                        if ($record['status'] == '1') {
                ...
                $data['record'] = $record = $this->Common_model->get_record('tbl_casted_gold_users', '*', ['id' => $user_id], 2);
                if (! empty($record)) {
                    if (! empty($_POST)) {
                    ...
                    $data['records'] = $this->Common_model->get_record('tbl_casted_gold_orders', '*', $where, 1, ['id', 'desc']);
                ...
                $precord     = $this->Common_model->get_record('tbl_casted_gold_promoters', '*', ['unique_code' => $promoter_id], 2);
                if (! empty($precord)) {
                    echo $precord['name'];
                }
                ...
                $data['home_content'] = $home_content = $this->Common_model->get_record('tbl_home_content', '*', ['id' => 1], 2);
                $data['record']       = $record       = $this->Common_model->get_record('tbl_cms_pages', '*', ['id' => 8], 2);
                $seo_tags             = [];
                if (! empty($record)) {
                    $seo_tags['title']            = $record['title'];
                    $seo_tags['meta_description'] = $record['meta_description'];
                ...
                $seo['seo_tags'] = $seo_tags;
                $data['places']  = $places  = $this->Common_model->get_record('tbl_pickup_places', '*', ['status' => 1], 1, ['id', 'desc']);
                if (! empty($this->session->userdata('casted_gold_dealer'))) {
                    $dealer_id       = $this->session->userdata('casted_gold_dealer');
                    $data['dealer']  = $dealer  = $this->Common_model->get_record('tbl_pickup_dealers', '*', ['id' => $dealer_id], 2);
                    $data['dealers'] = $dealers = $this->Common_model->get_record('tbl_pickup_dealers', '*', ['place_id' => $dealer['place_id'], 'status' => 1], 1, ['id', 'desc']);
                }
                ...
                $data['home_content']  = $home_content  = $this->Common_model->get_record('tbl_home_content', '*', ['id' => 1], 2);
                $user_id               = $this->session->userdata('casted_gold_user');
                $data['urecord']       = $urecord       = $this->Common_model->get_record('tbl_casted_gold_users', '*', ['id' => $user_id], 2);
                $data['cart_products'] = $this->session->userdata('casted_gold_cart_products');
                $data['casted_value']  = $casted_value  = $this->get_casted_value(1);
                $data['products']      = $this->Common_model->get_record('tbl_casted_gold_products', '*', ['status' => 1], 1, ['id', 'desc']);
                ...
                if (! empty($_POST['promoter_id'])) {
                    ...
                    $data['promoter'] = $promoter = $this->Common_model->get_record('tbl_casted_gold_promoters', '*', ['unique_code' => $promoter_id], 2);
                }
                $this->load->view('casted_gold_checkout_ajax', $data);
            } else if ($seg1 == "casted_gold_order_ajax") {
                $casted_value  = $this->get_casted_value(1);
                $home_content  = $this->Common_model->get_record('tbl_home_content', '*', ['id' => 1], 2);
                $user_id       = $this->session->userdata('casted_gold_user');
                $user          = $this->Common_model->get_record('tbl_casted_gold_users', '*', ['id' => $user_id], 2);
                $cart_products = $this->session->userdata('casted_gold_cart_products');

                $dealer_id = $this->session->userdata('casted_gold_dealer');
                $dealer    = $this->Common_model->get_record('tbl_pickup_dealers', '*', ['id' => $dealer_id], 2);
                $pickup    = $this->Common_model->get_record('tbl_pickup_places', '*', ['id' => $dealer['place_id']], 2);
                ...
                if (! empty($cart_products)) {
                    foreach ($cart_products as $pkey => $prow) {
                        $qty            = $prow['qty'];
                        $product        = $this->Common_model->get_record('tbl_casted_gold_products', '*', ['id' => $prow['pid']], 2);
                ...
                if (! empty($result)) {
                    if (! empty($cart_products)) {
                        foreach ($cart_products as $pkey => $prow) {
                            $qty      = $prow['qty'];
                            $product  = $this->Common_model->get_record('tbl_casted_gold_products', '*', ['id' => $prow['pid']], 2);
                            $category = $this->Common_model->get_record('tbl_casted_gold_categories', '*', ['id' => $product['category_id']], 2);
                ...
                $data['order']        = $order        = $this->Common_model->get_record('tbl_casted_gold_orders', '*', ['id' => $order_id], 2);
                $this->load->view($this->header, $seo);
                ...
                $data['home_content'] = $this->Common_model->get_record('tbl_home_content', '*', ['id' => 1], 2);
                $data['record']       = $this->Common_model->get_record('tbl_casted_gold_orders', '*', ['id' => $id], 2);

                $data['order_products'] = $this->Common_model->get_record('tbl_casted_gold_order_products', '*', ['order_id' => $id], 1, ['id', 'ASC']);
                ...
                $data['record'] = $record = $this->Common_model->get_record('tbl_cms_pages', '*', ['id' => 1], 2);
                $seo_tags       = [];
                if (! empty($record)) {
                    $seo_tags['title']            = $record['title'];
                    $seo_tags['meta_description'] = $record['meta_description'];
                ...
                $data['erecord']    = $erecord    = $this->Common_model->get_record('tbl_casted_gold_employees', '*', ['unique_code' => $unique_code, 'password' => $password], 2);
                $data['precord']    = $precord    = $this->Common_model->get_record('tbl_casted_gold_promoters', '*', ['unique_code' => $unique_code, 'password' => $password], 2);
                $data['commission'] = $this->Common_model->get_record('tbl_casted_gold_commission', '*', ['id' => 1], 2);
                if (! empty($erecord)) {
                    $data['type']      = 0;
                ...
                $seo['seo_tags']      = $seo_tags;
                $categories           = $this->Common_model->get_record('tbl_casted_silver_categories', '*', ['status' => 1], 1, ['display_order', 'asc']);
                $data['casted_value'] = $casted_value = $this->get_casted_value(4);
                $all_categories       = [];
                if (! empty($categories)) {
                    foreach ($categories as $key => $row) {
                        $row['products']  = $this->Common_model->get_record('tbl_casted_silver_products', '*', ['category_id' => $row['id']], 1, ['id', 'desc']);
                        $row['ads']       = $this->Common_model->get_record('tbl_casted_silver_ads', '*', ['category_id' => $row['id']], 1, ['id', 'desc']);
                        $all_categories[] = $row;
                    }
                }
                $data['categories'] = $all_categories;
                ...
                if ($this->input->post('unique_code') != '') {
                    ...
                    $password        = $this->input->post('password');
                    $encode_password = encode5t($password);
                    $record          = $this->Common_model->get_record('tbl_casted_silver_users', '*', ['unique_code' => $unique_code, 'password' => $encode_password], 2);
                    if (! empty($record)) {
                        if ($record['status'] == '1') {
                ...
                $data['record'] = $record = $this->Common_model->get_record('tbl_casted_silver_users', '*', ['id' => $user_id], 2);
                if (! empty($record)) {
                    if (! empty($_POST)) {
                        $data['from_date'] = $from_date = date("Y-m-d", strtotime($_POST['from_date']));
                        $data['to_date']   = $to_date   = date("Y-m-d", strtotime($_POST['to_date']));
                    ...
                    $where           = "user_id=" . $user_id . " AND date(order_date_time)>='" . $from_date . "' AND date(order_date_time)<='" . $to_date . "'";
                    $data['records'] = $this->Common_model->get_record('tbl_casted_silver_orders', '*', $where, 1, ['id', 'desc']);
                ...
                $promoter_id = $this->input->post('promoter_id');
                $precord     = $this->Common_model->get_record('tbl_casted_silver_promoters', '*', ['unique_code' => $promoter_id], 2);
                if (! empty($precord)) {
                    echo $precord['name'];
                }
                ...
                $data['home_content']  = $home_content  = $this->Common_model->get_record('tbl_home_content', '*', ['id' => 1], 2);
                $user_id               = $this->session->userdata('casted_silver_user');
                $data['urecord']       = $urecord       = $this->Common_model->get_record('tbl_casted_silver_users', '*', ['id' => $user_id], 2);
                $data['cart_products'] = $this->session->userdata('casted_silver_cart_products');
                $data['casted_value']  = $casted_value  = $this->get_casted_value(4);
                $data['products']      = $this->Common_model->get_record('tbl_casted_silver_products', '*', ['status' => 1], 1, ['id', 'desc']);
                ...
                if (! empty($_POST['promoter_id'])) {
                    $promoter_id      = $_POST['promoter_id'];
                    $data['promoter'] = $promoter = $this->Common_model->get_record('tbl_casted_silver_promoters', '*', ['unique_code' => $promoter_id], 2);
                }
                ...
                $home_content  = $this->Common_model->get_record('tbl_home_content', '*', ['id' => 1], 2);
                $user_id       = $this->session->userdata('casted_silver_user');
                $user          = $this->Common_model->get_record('tbl_casted_silver_users', '*', ['id' => $user_id], 2);
                ...
                if (! empty($cart_products)) {
                    foreach ($cart_products as $pkey => $prow) {
                        $qty            = $prow['qty'];
                        $product        = $this->Common_model->get_record('tbl_casted_silver_products', '*', ['id' => $prow['pid']], 2);
                        $purity_amount  = ($product['purity_percentage'] * $casted_value) / 100;
                        $price2         = $casted_value - $purity_amount;
                        $final_price    = $price2 * $product['weight'];
                        $product_total  = $final_price * $qty;
                ...
                if (! empty($result)) {
                    if (! empty($cart_products)) {
                        foreach ($cart_products as $pkey => $prow) {
                            $qty      = $prow['qty'];
                            $product  = $this->Common_model->get_record('tbl_casted_silver_products', '*', ['id' => $prow['pid']], 2);
                            $category = $this->Common_model->get_record('tbl_casted_silver_categories', '*', ['id' => $product['category_id']], 2);
                ...
                $data['order']        = $order        = $this->Common_model->get_record('tbl_casted_silver_orders', '*', ['id' => $order_id], 2);
                $this->load->view($this->header, $seo);
                ...
                $data['home_content'] = $this->Common_model->get_record('tbl_home_content', '*', ['id' => 1], 2);
                $data['record']       = $this->Common_model->get_record('tbl_casted_silver_orders', '*', ['id' => $id], 2);

                $data['order_products'] = $this->Common_model->get_record('tbl_casted_silver_order_products', '*', ['order_id' => $id], 1, ['id', 'ASC']);
                ...
                $password           = $this->input->post('password');
                $password           = encode5t($password);
                $data['erecord']    = $erecord    = $this->Common_model->get_record('tbl_casted_silver_employees', '*', ['unique_code' => $unique_code, 'password' => $password], 2);
                $data['precord']    = $precord    = $this->Common_model->get_record('tbl_casted_silver_promoters', '*', ['unique_code' => $unique_code, 'password' => $password], 2);
                $data['commission'] = $this->Common_model->get_record('tbl_casted_silver_commission', '*', ['id' => 1], 2);
                if (! empty($erecord)) {
                    $data['type']      = 0;
                    $data['emp_id']    = $erecord['id'];
                    $data['from_date'] = $from_date = date("Y-m-d");
                ...
                $data['crecord']      = $this->Common_model->get_record('tbl_categories', '*', ['id' => 2], 2);
                $categories           = $this->Common_model->get_record('tbl_minted_categories', '*', ['status' => 1], 1, ['display_order', 'asc']);
                $all_categories       = [];
                if (! empty($categories)) {
                    foreach ($categories as $key => $row) {
                        $row['products']  = $this->Common_model->get_record('tbl_minted_products', '*', ['category_id' => $row['id']], 1, ['id', 'desc']);
                        $row['ads']       = $this->Common_model->get_record('tbl_minted_ads', '*', ['category_id' => $row['id']], 1, ['id', 'desc']);
                        $all_categories[] = $row;
                    }
                }
                $data['categories'] = $all_categories;
                ...
                if (! empty($minted_cart_products)) {
                    foreach ($minted_cart_products as $key => $row) {
                        $product        = $this->Common_model->get_record('tbl_minted_products', '*', ['id' => $row['pid']], 2);
                        $product['qty'] = $row['qty'];
                        $records[]      = $product;
                    }
                }
                ...
                $data['crecord']      = $this->Common_model->get_record('tbl_categories', '*', ['id' => 5], 2);
                $categories           = $this->Common_model->get_record('tbl_minted_silver_categories', '*', ['status' => 1], 1, ['display_order', 'asc']);
                $all_categories       = [];
                if (! empty($categories)) {
                    foreach ($categories as $key => $row) {
                        $row['products']  = $this->Common_model->get_record('tbl_minted_silver_products', '*', ['category_id' => $row['id']], 1, ['id', 'desc']);
                        $row['ads']       = $this->Common_model->get_record('tbl_minted_silver_ads', '*', ['category_id' => $row['id']], 1, ['id', 'desc']);
                        $all_categories[] = $row;
                    }
                }
                $data['categories'] = $all_categories;
                ...
                if (! empty($minted_silver_cart_products)) {
                    foreach ($minted_silver_cart_products as $key => $row) {
                        $product        = $this->Common_model->get_record('tbl_minted_silver_products', '*', ['id' => $row['pid']], 2);
                        $product['qty'] = $row['qty'];
                        $records[]      = $product;
                    }
                }
                ...
                $records  = $this->Common_model->get_record('tbl_pickup_dealers', '*', ['place_id' => $place_id, 'status' => 1], 1, ['id', 'desc']);
                ...
                $seo['seo_tags'] = $seo_tags;
                $this->load->view($this->header, $seo);
                $data['pdfs'] = $this->Common_model->get_record('tbl_about_pdf', '*', ['status' => 1], 1, ['position', 'asc']);
                $this->load->view('about', $data);
                $this->load->view($this->footer);
            } else if ($seg1 == "selling-authority") {
                $data['record'] = $record = $this->Common_model->get_record('tbl_cms_pages', '*', ['id' => 2], 2);
                $seo_tags       = [];
                if (! empty($record)) {
                    $seo_tags['title']            = $record['title'];
                    $seo_tags['meta_description'] = $record['meta_description'];
                ...
                $data['record'] = $record = $this->Common_model->get_record('tbl_cms_pages', '*', ['id' => 3], 2);
                $seo_tags       = [];
                if (! empty($record)) {
                    $seo_tags['title']            = $record['title'];
                    $seo_tags['meta_description'] = $record['meta_description'];
                ...
                $data['record'] = $record = $this->Common_model->get_record('tbl_contact_us_details', '*', ['id' => 1], 2);
                $seo_tags       = [];
                if (! empty($record)) {
                    $seo_tags['title']            = $record['title'];
                    $seo_tags['meta_description'] = $record['meta_description'];
                ...
                $seo['seo_tags']   = $seo_tags;
                $data['addresses'] = $addresses = $this->Common_model->get_record('tbl_contact_addresses', '*', ['status' => 1], 1, ['id', 'desc']);
                $this->load->view($this->header, $seo);
                ...
                $data['record'] = $record = $this->Common_model->get_record('tbl_cms_pages', '*', ['id' => 4], 2);
                $seo_tags       = [];
                if (! empty($record)) {
                    $seo_tags['title']            = $record['title'];
                    $seo_tags['meta_description'] = $record['meta_description'];
                ...
                $data['record'] = $record = $this->Common_model->get_record('tbl_cms_pages', '*', ['id' => 5], 2);
                $seo_tags       = [];
                if (! empty($record)) {
                    $seo_tags['title']            = $record['title'];
                    $seo_tags['meta_description'] = $record['meta_description'];
                ...
                $seo['seo_tags'] = $seo_tags;
                $this->load->view($this->header, $seo);
                $records     = $this->Common_model->get_record('tbl_pickup_places', '*', ['status' => 1], 1, ['position', 'asc']);
                $all_records = [];
                if (! empty($records)) {
                    foreach ($records as $key => $row) {
                        $row['dealers'] = $this->Common_model->get_record('tbl_pickup_dealers', '*', ['place_id' => $row['id'], 'status' => 1], 1, ['id', 'desc']);
                        $all_records[]  = $row;
                    }
                }
                ...
                $password       = $this->input->post('password');
                $password       = encode5t($password);
                $data['record'] = $record = $this->Common_model->get_record('tbl_pickup_dealers', '*', ['unique_code' => $unique_code, 'password' => $password], 2);
                if (! empty($record)) {
                ...
                $data['drecord'] = $drecord = $this->Common_model->get_record('tbl_vi_payments_details', '*', ['id' => 1], 2);
                $unique_code     = $this->input->post('unique_code');
                $password        = $this->input->post('password');
                $password        = encode5t($password);
                $data['erecord'] = $erecord = $this->Common_model->get_record('tbl_vi_pro', '*', ['unique_code' => $unique_code, 'password' => $password], 2);
                $data['precord'] = $precord = $this->Common_model->get_record('tbl_vi_super', '*', ['unique_code' => $unique_code, 'password' => $password], 2);
                if (! empty($erecord)) {
                    $data['type']    = 0;
                    $data['emp_id']  = $erecord['id'];
                    $data['heading'] = $heading = date("Y-m-01");
                    $data['records'] = $records = $this->Common_model->get_record('tbl_vi_pro', '*', ['id' => $erecord['id']], 1, ['id', 'desc']);
                    ...
                    $super_records       = $this->Common_model->get_record('tbl_vi_super', '*', ['employee_id' => $erecord['id']], 1, ['id', 'desc']);
                    $pro_amount          = [];
                    $super_records_final = [];
                    ...
                    $data['emp_id']      = $precord['id'];
                    $data['heading']     = $heading     = date("Y-m-01");
                    $super_records       = $this->Common_model->get_record('tbl_vi_super', '*', ['id' => $precord['id']], 1, ['id', 'desc']);
                    $super_records_final = [];
                    if (! empty($super_records)) {
                        foreach ($super_records as $key => $row) {
                            $row['super_amount']   = $this->db->query("Select SUM(super_amount) as total_super_amount from tbl_vi_super_payments where super_id=" . $row['id'] . " AND heading='" . $heading . "' AND date>='" . $row['date'] . "'")->row_array();
                ...
                if ($type == 0) {
                    $data['records'] = $records = $this->Common_model->get_record('tbl_vi_pro', '*', ['id' => $emp_id], 1, ['id', 'desc']);
                    ...
                    $super_records       = $this->Common_model->get_record('tbl_vi_super', '*', ['employee_id' => $emp_id], 1, ['id', 'desc']);
                    $pro_amount          = [];
                    $super_records_final = [];
                    if (! empty($super_records)) {
                        foreach ($super_records as $key => $row) {
                    ...
                    $super_records       = $this->Common_model->get_record('tbl_vi_super', '*', ['id' => $emp_id], 1, ['id', 'desc']);
                    $super_records_final = [];
                    if (! empty($super_records)) {
                        foreach ($super_records as $key => $row) {
                            $row['super_amount']   = $this->db->query("Select SUM(super_amount) as total_super_amount from tbl_vi_super_payments where super_id=" . $row['id'] . " AND heading='" . $heading . "' AND date>='" . $row['date'] . "'")->row_array();
            ...
            } else if ($seg1 == "api_visave_user_ajax") {
                $unique_code     = $this->input->post('unique_code');
                $password        = $this->input->post('password');
                $password        = encode5t($password);
                $data['pwd']     = $password;
                $where           = "unique_code='" . $unique_code . "' AND password='" . $password . "'";
                $data['urecord'] = $this->Common_model->get_record('tbl_visave_users', '*', ['unique_code' => $unique_code, 'password' => $password], 2);
                $data['grecord'] = $this->Common_model->get_record('tbl_visave_group_users', '*', ['unique_code' => $unique_code, 'password' => $password], 2);
                $data['precord'] = $this->Common_model->get_record('tbl_visave_promoters', '*', ['unique_code' => $unique_code, 'password' => $password], 2);
                $data['erecord'] = $this->Common_model->get_record('tbl_visave_employees', '*', ['unique_code' => $unique_code, 'password' => $password], 2);
                ...
                //     $data['payments']  = $this->Common_model->get_record('tbl_visave_user_payments', '*', ['user_id' => $urecord['id']], 1, ['id', 'asc']);
                //     $data['bonus']     = $this->Common_model->get_record('tbl_visave_user_bonus', '*', ['user_id' => $urecord['id']], 1, ['id', 'asc']);
                //     $data['penalties'] = $this->Common_model->get_record('tbl_visave_user_penalties', '*', ['user_id' => $urecord['id']], 1, ['id', 'asc']);
                ...
                $password    = encode5t($password);
                $where       = "unique_code='" . $unique_code . "' AND password='" . $password . "'";
                $urecord     = $this->Common_model->get_record('tbl_visave_users', '*', ['unique_code' => $unique_code, 'password' => $password], 2);
                $grecord     = $this->Common_model->get_record('tbl_visave_group_users', '*', ['unique_code' => $unique_code, 'password' => $password], 2);
                $precord     = $this->Common_model->get_record('tbl_visave_promoters', '*', ['unique_code' => $unique_code, 'password' => $password], 2);
                $erecord     = $this->Common_model->get_record('tbl_visave_employees', '*', ['unique_code' => $unique_code, 'password' => $password], 2);
                if (! empty($urecord)) {
                    $data['type']      = 0;
                    $data['record']    = $this->db->query("Select t1.*,t2.category_name,t3.sub_category_name,t4.name as promoter_name from tbl_visave_users t1 left join tbl_visave_categories t2 on t1.category_id=t2.id left join tbl_visave_sub_categories t3 on t1.sub_category_id=t3.id left join tbl_visave_promoters t4 on t1.promoter_id=t4.id where t1.id=" . $urecord['id'] . "")->row_array();
                    $data['payments']  = $this->Common_model->get_record('tbl_visave_user_payments', '*', ['user_id' => $urecord['id']], 1, ['id', 'asc']);
                    ...
                    $data['lucky_draw'] = $this->Common_model->get_record('tbl_visave_group_lucky_draw', '*', ['group_id' => $grecord['group_id']], 1, ['id', 'asc']);
                    $data['payments']   = $this->Common_model->get_record('tbl_visave_group_user_payments', '*', ['user_id' => $grecord['id']], 1, ['id', 'asc']);
                    $data['bonus']      = $this->Common_model->get_record('tbl_visave_group_user_bonus', '*', ['user_id' => $grecord['id']], 1, ['id', 'asc']);
                    $data['penalties']  = $this->Common_model->get_record('tbl_visave_group_user_penalties', '*', ['user_id' => $grecord['id']], 1, ['id', 'asc']);
                    ...
                    if (! empty($uresult)) {
                        foreach ($uresult as $key => $row) {
                            $row['payments']  = $this->Common_model->get_record('tbl_visave_user_payments', '*', ['user_id' => $row['id']], 1, ['id', 'asc']);
                            $row['bonus']     = $this->Common_model->get_record('tbl_visave_user_bonus', '*', ['user_id' => $row['id']], 1, ['id', 'asc']);
                            $row['penalties'] = $this->Common_model->get_record('tbl_visave_user_penalties', '*', ['user_id' => $row['id']], 1, ['id', 'asc']);
                            $urecords[]       = $row;
                        }
                    }
                    ...
                    if (! empty($gresult)) {
                        foreach ($gresult as $key => $row) {
                            $row['lucky_draw'] = $this->Common_model->get_record('tbl_visave_group_lucky_draw', '*', ['group_id' => $row['group_id']], 1, ['id', 'asc']);
                            $row['payments']   = $this->Common_model->get_record('tbl_visave_group_user_payments', '*', ['user_id' => $row['id']], 1, ['id', 'asc']);
                            $row['bonus']      = $this->Common_model->get_record('tbl_visave_group_user_bonus', '*', ['user_id' => $row['id']], 1, ['id', 'asc']);
                            $row['penalties']  = $this->Common_model->get_record('tbl_visave_group_user_penalties', '*', ['user_id' => $row['id']], 1, ['id', 'asc']);
                            $grecords[]        = $row;
                        }
                    }
                    ...
                    $data['type']   = 3;
                    $data['record'] = $erecord;
                    $promoters      = $this->Common_model->get_record('tbl_visave_promoters', '*', ['employee_id' => $erecord['id']], 1, ['id', 'asc']);
                    $precords       = [];
                    if (! empty($promoters)) {
                ...
                if ($type == 0) {
                    $result = $this->Common_model->update_record('tbl_visave_users', $update_data, ['id' => $id]);
                } else {
                    $result = $this->Common_model->update_record('tbl_visave_group_users', $update_data, ['id' => $id]);
                }
                echo 1;
                ...
                if ($user_data['type'] == 0) {
                    ...
                    $data['payments']  = $this->Common_model->get_record('tbl_visave_user_payments', '*', ['user_id' => $user_data['id']], 1, ['id', 'asc']);
                    $data['bonus']     = $this->Common_model->get_record('tbl_visave_user_bonus', '*', ['user_id' => $user_data['id']], 1, ['id', 'asc']);
                    $data['penalties'] = $this->Common_model->get_record('tbl_visave_user_penalties', '*', ['user_id' => $user_data['id']], 1, ['id', 'asc']);
                } else {
                    ...
                    $data['payments']  = $this->Common_model->get_record('tbl_visave_group_user_payments', '*', ['user_id' => $user_data['id']], 1, ['id', 'asc']);
                    $data['bonus']     = $this->Common_model->get_record('tbl_visave_group_user_bonus', '*', ['user_id' => $user_data['id']], 1, ['id', 'asc']);
                    $data['penalties'] = $this->Common_model->get_record('tbl_visave_group_user_penalties', '*', ['user_id' => $user_data['id']], 1, ['id', 'asc']);
                }
    ...
    public function get_casted_value($id)
    {
        ...
        $record       = $this->Common_model->get_record('tbl_categories', '*', ['id' => $id], 2);
