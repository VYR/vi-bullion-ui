...
<form id="search_form" method="post">
      ...
      <div class="col-md-3">
         <div class="form-group">
            ...
            <select id="category_id" name="category_id" class="form-control" required>
				...
				<option value="4">Casted Silver</option>
			</select>
         </div>
      </div>
      <div class="col-md-3">
         <div class="form-group">
            <label class="text-white">Unique Code:</label>
  ...
  <label for="email">Search:</label>
        <button type="submit" id="submit_id" class="btn abt-btn btn-block">SEARCH</button> 
      </div>
   </div>
</form>
<div id="orders_div">
...
<script>
	$(document).ready(function(){
		...
		type: "POST",    
		dataType: "html",    
		url: "<?php echo site_url(); ?>pickup_dashboard_check",    
