...
<h1 class="text-center ncolor3 text-uppercase">Casted Silver</h1>
<div id="products_div">
<?php	
	if(!empty($categories)){
...
<div class="<?php echo $pcol; ?> col-sm-6 mb-3">
	<div class="p-3 border nbr3 text-white rounded text-center h-100">
		<h5><?php echo $row1['name']; ?></h5>
		<img src="<?php echo base_url(); ?>assets/images/casted_silver/<?php echo $row1['image']; ?>" alt="<?php echo $row1['image_alt']; ?>" style="max-width:100%;">
...
<script>
	...
	function addCart(pid)
	{
		...
		$.ajax({  
			type: "POST",    
			dataType: "html",    
			url: "<?php echo site_url(); ?>casted_silver_add_cart",    
			data: { pid:pid,qty:qty }})
			.done(function(data){
			location.href="<?php echo site_url(); ?>casted-silver-booking";
		});
	} 		 
</script>