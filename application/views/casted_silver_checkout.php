...
<script>
	...
	function getCheckout(){
		$.ajax({    
			type: "POST",    
			dataType: "html",    
			url:"<?php echo base_url(); ?>casted_silver_checkout_ajax",
	...
	function submitOrder(){
		...
		type: "POST",    
		dataType: "html",    
		url:"<?php echo base_url(); ?>casted_silver_order_ajax",
		data: $("#submit_form").serialize()})
		.done(function(data) {
			...
			if(jsondata['status']==1)
			{
				...
				setTimeout(function(){ window.location.href="<?php echo site_url(); ?>casted-silver-success"; }, 1000);
			}
			else
			{
