...
<div class="table-responsive">
	...
	<td>
	<button type="button" class="btn btn-sm abt-btn" onclick="getPromoters('<?php echo $row['unique_code']; ?>')">promoters</button>
	</td>
	</tr>
	...
	<td>
	<button type="button" class="btn btn-sm abt-btn" onclick="getSales('<?php echo $prow['unique_code']; ?>')">Sales</button>
	</td>
	</tr>
	...
	<td>
	<a target="_blank" href="<?php echo base_url(); ?>casted_gold_sales_download_admin?id=<?php echo $orow['id']; ?>" class="btn btn-sm abt-btn"><i class="fa fa-download"></i> Download</a>
	</td>
	</tr>
	<?php }  ?>
	</tbody>
...
<script>
	...
	$(document).ready(function(){		
		...
		type: "POST",    
		dataType: "html",    
		url: "<?php echo site_url(); ?>casted_gold_dashboard_ajax",    
