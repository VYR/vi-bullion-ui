...
<?php if(!empty($precords)){ foreach($precords as $key2 => $row2){ ?> 	
<div class="table-responsive">
	<table class="table table-bordered table-striped">            
		<thead class="nbg2 text-white">       
		<tr>      
		...
		<tbody>	
			<tr class="text-center text-white">
				...
				<td>
				<button type="button" class="btn btn-sm abt-btn" onclick="getPromoters('<?php echo $row2['id']; ?>')">View</button>
				</td>
			</tr>
		</tbody>
	</table>
</div>
<div class="all_promoters" id="all_pro_<?php echo $row2['id']; ?>" style="display:none;">
<!--
<h3 class="text-white">Individual Users</h3>
<?php if(!empty($row2['urecords'])){ ?> 	
<div class="table-responsive">
	<table class="table table-bordered table-striped">            
		<thead class="nbg2 text-white">       
		<tr>      
		...
		<tbody>	
			<?php 
				foreach($row2['urecords'] as $key => $row){
...
<div class="table-responsive">
	<table class="table table-bordered table-striped">            
		...
		<tbody>	
			<?php 
				foreach($row2['grecords'] as $key => $row){
				$commission_array=array();
				if(!empty($row['payments'])){
				foreach($row['payments'] as $key => $row1){ 
					if($row1['payment_status']==1){
