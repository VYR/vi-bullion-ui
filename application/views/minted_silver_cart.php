...
<div class="container py-5" style="min-height:500px;">
	<h1 class="text-center ncolor3 text-uppercase">Minted Silver Cart</h1>
	<div class="border nbr3 text-white">
		<div class="nbg3 text-white p-1">
...
<script>
	...
	function removeCart(pid)
	{
		$.ajax({  
			type: "POST",    
			dataType: "html",    
			url: "<?php echo site_url(); ?>minted_silver_remove_cart",    
			data: { pid:pid }})
			.done(function(data){
			getCart();
		});
	...
	function getCart()
	{
		$.ajax({  
			type: "POST",    
			dataType: "html",    
			url: "<?php echo site_url(); ?>minted_silver_cart_ajax",    
			data: { pid:1 }})
			.done(function(data){
			$("#cart_div").html(data);
		});
