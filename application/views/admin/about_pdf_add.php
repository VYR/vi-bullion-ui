...
$(document).ready(function(){	
	...
	$("#submit_form").on("submit", function(e){
				...
				$.post({
					...
					url:"<?php echo base_url(); ?>admin/about_pdf_ajax",
					...
					{		
...

						{
							...
							setTimeout(function(){ window.location = "<?php echo base_url(); ?>admin/about_pdf"; }, 1000);
  ...
  <div class="content-wrapper">
	...
	<form role="form" id="submit_form" method="post" enctype="multipart/form-data">
		...
		<div class="row" >
			...
			<label for="cat_slno" class="control-label">Link <span class="text-danger">*</span></label>

			<input type="text" class="form-control" id="link" name="link" placeholder="Enter link" value="<?php if(!empty($record)){ echo $record['link']; } ?>" required>

			</div>
			<div class="col-xs-12 form-group">

			<label for="cat_slno" class="control-label">Code <span class="text-danger">*</span></label>

			<input type="text" class="form-control" id="code" name="code" placeholder="Enter Code" value="<?php if(!empty($record)){ echo $record['code']; } ?>" required>
			...
			<label for="cat_slno" class="control-label">Pdf <span class="text-danger">*</span></label>
			<?php if(!empty($record)){ ?>			
			<a href="<?php echo site_url(); ?>assets/images/about/<?php echo $record['pdf']; ?>" target="_blank">Click Here</a>				
			<?php } ?>
