...
$(document).ready(function(){	
	...
	$("#submit_form").on("submit", function(e){
				...
				$.post({
					type: "post",
					url:"<?php echo base_url(); ?>admin/casted_gold_users_ajax",
					data:data,
					processData: false,
					contentType: false,
					...
					{		
						...
						if(jsondata['status']==1)
						{
							...
							setTimeout(function(){ window.location = "<?php echo base_url(); ?>admin/casted_gold_users"; }, 1000);
						}
						else
						{
	...
	function get_casted_promoter(){
		...
		$.ajax({    
			type: "POST",    
			dataType: "html",    
			url: "<?php echo base_url(); ?>get_casted_promoter",    
	...
	<form role="form" id="submit_form" method="post" enctype="multipart/form-data">
		<div class="row" >
			...
			<div class="col-md-3 form-group">
				...
				<input type="text" class="form-control" id="promoter_id" name="promoter_id" placeholder="Enter Promoter ID" onkeyup="get_casted_promoter()" autocomplete="off" value="<?php if(!empty($record)){ echo $record['promoter_id']; } ?>" required>
			</div>
			<div class="col-md-3 form-group">
