...
$(document).ready(function(){	
	...
	$("#submit_form").on("submit", function(e){
				...
				$.post({
					type: "post",
					url:"<?php echo base_url(); ?>admin/cms_pages_ajax",
					data:data,
					processData: false,
					contentType: false,
					...
					{		
						...
						if(jsondata['status']==1)
						{
							...
							setTimeout(function(){ window.location = "<?php echo base_url(); ?>admin/cms_pages"; }, 1000);
						}
						else
						{
	...
	<form role="form" id="submit_form" method="post" enctype="multipart/form-data">
		<div class="row" >
			<div class="col-md-12 form-group">
				<label for="cat_slno" class="control-label">Page Name</label><br>
				<?php if(!empty($record)){ echo $record['page_name']; } ?>
			...
			<div class="col-md-12 form-group">
				...
				<textarea class="ckeditor" id="description" name="description"><?php if(!empty($record)){ echo $record['description']; } ?></textarea>
			</div>
			<div class="col-md-12 form-group">
