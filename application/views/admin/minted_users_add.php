...
$(document).ready(function(){	
	...
	$("#submit_form").on("submit", function(e){
				...
				$.post({
					type: "post",
					url:"<?php echo base_url(); ?>admin/minted_users_ajax",
					data:data,
					processData: false,
					contentType: false,
	...
	<form role="form" id="submit_form" method="post" enctype="multipart/form-data">
		<div class="row" >
			...
			<div class="col-md-3 form-group">
				...
				<input type="text" class="form-control" id="promoter_id" name="promoter_id" placeholder="Enter Promoter ID" onkeyup="get_minted_promoter()" autocomplete="off" value="<?php if(!empty($record)){ echo $record['promoter_id']; } ?>" required>
			</div>
			<div class="col-md-3 form-group">
