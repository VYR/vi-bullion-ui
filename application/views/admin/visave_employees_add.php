...
$(document).ready(function(){	
	...
	$("#submit_form").on("submit", function(e){
				...
				$.post({
					type: "post",
					url:"<?php echo base_url(); ?>admin/visave_employees_ajax",
					data:data,
					processData: false,
					contentType: false,
					...
					{		
						...
						if(jsondata['status']==1)
						{
							...
							setTimeout(function(){ window.location = "<?php echo base_url(); ?>admin/visave_employees"; }, 1000);
						}
						else
						{
  ...
  <div class="content-wrapper">
	...
	<form role="form" id="submit_form" method="post" enctype="multipart/form-data">
		<div class="row" >
			...
			<label for="cat_slno" class="control-label">Employee Code <span class="text-danger">*</span></label>
			<input type="text" class="form-control" id="unique_code" name="unique_code" placeholder="Enter Employee Code" value="<?php if(!empty($record)){ echo $record['unique_code']; } ?>" required>
			...
			<div class="col-md-4 form-group">
				...
				<a href="<?php echo base_url(); ?>admin/visave_employees" class="btn btn-danger">Cancel</a>
