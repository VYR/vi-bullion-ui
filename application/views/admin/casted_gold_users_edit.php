...
$(document).ready(function(){	
	...
	$("#submit_form").on("submit", function(e){
				...
				$.post({
					type: "post",
					url:"<?php echo base_url(); ?>admin/casted_gold_users_edit_ajax",
					data:data,
					processData: false,
					contentType: false,
  ...
  <div class="content-wrapper">
	...
	<form role="form" id="submit_form" method="post" enctype="multipart/form-data">
		<div class="row" >
			...
			<div class="col-md-4 form-group">
				<label for="name">Deposit amount<span class="text-danger">*</span></label>
				<input type="text" class="form-control" id="deposit_amount" name="deposit_amount" placeholder="Enter Deposit amount" value="<?php if(!empty($record)){ echo $record['deposit_amount']; } ?>" required>
			</div>
			<div class="col-md-4 form-group">
