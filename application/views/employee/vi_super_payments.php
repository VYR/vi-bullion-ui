      ...
      <div class="row">
        <div class="col-xs-12">
			...
			<div class="box">
				...
				<h3 class="box-title">Vi Super Details</h3>
				<div id="dmsg"></div>
				</div>
				...
				<td><?php echo $super['mobile']; ?></td>
				<td><?php echo $super['email']; ?></td>
				<td><?php echo $super['amount']; ?></td>
				</tr>
				</tbody></table>
				</div>
			</div>
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Vi Super Payments</h3>
			   <div id="dmsg"></div>
            </div>
            <!-- /.box-header -->
			<?php	
