...
$(document).ready(function(){	
	...
	$("#submit_form").on("submit", function(e){
				...
				$.post({
					type: "post",
					url:"<?php echo base_url(); ?>admin/casted_products_prices_ajax",
					data:data,
					processData: false,
					contentType: false,
	...
	function getPricing()
	{
		...
		$.ajax({  
			type: "POST",    
			dataType: "html",    
			url: "<?php echo site_url(); ?>admin/casted_products_prices_loop",    
  ...
  <div class="content-wrapper">
	...
	<form role="form" id="submit_form" method="post" enctype="multipart/form-data">
		<div class="row" >
			...
			<div class="col-md-3 form-group">
			<label for="cat_slno" class="control-label">K Value <span class="text-danger">*</span></label>
			<input type="text" class="form-control" id="k_value" name="k_value" placeholder="Enter Value" value="<?php if(!empty($record)){ echo $record['k_value']; } ?>" required>
			</div>
			<div class="col-md-3 form-group">
          ...
          <div class="box">
            ...
            <div class="box-body">
				...
				<div class="row">
					...
					<div class="col-md-2 form-group">
						<label>H (equal)</label>
						<?php $h_value=$f_value+$record['g_value']; ?>
					...
					<div class="col-md-2 form-group">
						<?php $i_value=($record['gst']*$h_value)/100; ?>					
						<label>I (GST)(add)</label>
						<input type="text" class="form-control" value="<?php echo round($i_value,2); ?>" readonly>
					</div>
					<div class="col-md-2 form-group">
						<?php $j_value=$h_value+$i_value; ?>
						<label>J (equal)</label>
						<input type="text" class="form-control" value="<?php echo round($j_value,2); ?>" readonly>
					</div>
					<div class="col-md-2 form-group">
						<?php $k_value=$record['k_value']; ?>					
						<label>K (add)</label>
						<input type="text" class="form-control" value="<?php echo round($k_value,2); ?>" readonly>
					</div>
					<div class="col-md-2 form-group">
						<?php $m_value=$j_value+$k_value; ?>
						<label>M (equal)</label>
						<input type="text" class="form-control" value="<?php echo round($m_value,2); ?>" readonly>
					</div>
					<div class="col-md-2 form-group">
