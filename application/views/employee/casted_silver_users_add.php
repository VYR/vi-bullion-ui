...
$(document).ready(function(){	
	...
	$("#submit_form").on("submit", function(e){
				...
				$.post({
					type: "post",
					url:"<?php echo base_url(); ?>admin/casted_silver_users_ajax",
					data:data,
					processData: false,
					contentType: false,
					...
					{		
						...
						if(jsondata['status']==1)
						{
							...
							setTimeout(function(){ window.location = "<?php echo base_url(); ?>admin/casted_silver_users"; }, 1000);
						}
						else
						{
	...
	function get_casted_silver_promoter(){
		$('#promoter_name').val('');	
		var promoter_id=$("#promoter_id").val();
		$.ajax({    
			type: "POST",    
			dataType: "html",    
			url: "<?php echo base_url(); ?>get_casted_silver_promoter",    
	...
	<form role="form" id="submit_form" method="post" enctype="multipart/form-data">
		<div class="row" >
			...
			<div class="col-md-4 form-group">
				...
				<input type="text" class="form-control" id="aadhar_number" name="aadhar_number" placeholder="Enter Aadhar Number" value="<?php if(!empty($record)){ echo $record['aadhar_number']; } ?>" required>
			</div>
			<div class="col-md-4 form-group">
			...
			<div class="col-md-3 form-group">
				...
				<input type="text" class="form-control" id="state_code" name="state_code" placeholder="Enter State Code" value="<?php if(!empty($record)){ echo $record['state_code']; } ?>" required>
			</div>
			<div class="col-md-3 form-group">
			...
			<div class="col-md-3 form-group">
				...
				<input type="text" class="form-control" id="promoter_id" name="promoter_id" placeholder="Enter Promoter ID" onkeyup="get_casted_silver_promoter()" autocomplete="off" value="<?php if(!empty($record)){ echo $record['promoter_id']; } ?>" required>
			</div>
			<div class="col-md-3 form-group">
