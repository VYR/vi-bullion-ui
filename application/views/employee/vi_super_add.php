...
$(document).ready(function(){	
	...
	$("#submit_form").on("submit", function(e){
				...
				$.post({
					type: "post",
					url:"<?php echo base_url(); ?>admin/vi_super_ajax",
					data:data,
					processData: false,
					contentType: false,
					...
					{		
						...
						if(jsondata['status']==1)
						{
							...
							setTimeout(function(){ window.location = "<?php echo base_url(); ?>admin/vi_super?id="+employee_id; }, 1000);
						}
						else
						{
	...
	<form role="form" id="submit_form" method="post" enctype="multipart/form-data">
		<div class="row" >
			<div class="col-md-12 form-group">
				<label for="name">Vi Pro<span class="text-danger">*</span></label>
			...
			<input type="text" class="form-control" id="amount" name="amount" maxlength="10" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" placeholder="Enter Amount" value="<?php if(!empty($record)){ echo $record['amount']; } ?>" required>
			</div>
			<div class="col-md-12 form-group">
			...
			<div class="col-md-4 form-group">
				...
				<a href="<?php echo base_url(); ?>admin/vi_super" class="btn btn-danger">Cancel</a>
