...
$(document).ready(function(){	
	...
	$("#submit_form").on("submit", function(e){
				...
				$.post({
					type: "post",
					url:"<?php echo base_url(); ?>admin/minted_silver_products_ajax",
					data:data,
					processData: false,
					contentType: false,
					...
					{		
						...
						if(jsondata['status']==1)
						{
							...
							setTimeout(function(){ window.location = "<?php echo base_url(); ?>admin/minted_silver_products"; }, 1000);
						}
						else
						{
	...
	<form role="form" id="submit_form" method="post" enctype="multipart/form-data">
		...
		<div class="row" >
			<div class="col-md-6 form-group">
				...
				<img src="<?php echo base_url(); ?>assets/images/minted_silver/<?php echo $record['image']; ?>" height="100">
				<?php } ?>
		...
		<div class="row" >
			...
			<input type="text" class="form-control" id="add_value" name="add_value" placeholder="Enter add value" value="<?php if(!empty($record)){ echo $record['add_value']; } ?>" required>
			</div>
			...
			<div class="col-md-4 form-group">
				...
				<a href="<?php echo base_url(); ?>admin/minted_silver_products" class="btn btn-danger">Cancel</a>
