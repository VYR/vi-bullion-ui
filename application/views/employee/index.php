...
<head>
	...
	<title>VI Bullion | Employee</title>
...
<script type="text/javascript">		
	$(document).ready(function(){	
		$("#login_form").on("submit", function(e){
			...
			$.ajax({
				type: "post",
				url:"<?php echo base_url(); ?>employee/ajax_login",
				...
				{		
					...
					if(jsondata['status']==1)
					{
						...
						$("#login_form")[0].reset();
						setTimeout(function(){ window.location = "<?php echo base_url(); ?>employee/dashboard"; }, 1000);
					}
					else
					{
...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>VI Bullion</b> Employee</a>
  </div>
  <!-- /.login-logo -->
