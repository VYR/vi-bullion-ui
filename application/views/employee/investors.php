...
$(document).ready(function(){	
  ...
  <div class="content-wrapper">
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
				<a href="<?php echo base_url(); ?>admin/investors_add" class="btn btn-primary">Add</a>
            </div>
            <!-- /.box-body -->
          </div>          <!-- /.box -->
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Investors Table</h3>
			   <div id="dmsg"></div>
            </div>
            <!-- /.box-header -->
	...
	<?php echo $row['contact_mobile']; ?><br>
	<?php echo $row['contact_email']; ?>
	</td>
	<td>
	<a href="<?php echo base_url(); ?>admin/investors_add?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-primary" title="Edit"><i class="fa fa-edit"></i></a>
	<a href="<?php echo base_url(); ?>admin/investors_delete?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger confirm_alert" data-title="Are you sure want to delete?" title="Delete"><i class="fa fa-trash"></i></a>
	</td>
	</tr>
	<?php }  }  ?>
			  </tbody></table>
