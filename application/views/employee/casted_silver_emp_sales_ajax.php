<div class="table-responsive">
	...
	<td>
	<a target="_blank" href="<?php echo base_url(); ?>admin/casted_silver_sales_download_admin?id=<?php echo $orow['id']; ?>" class="btn btn-sm btn-success"><i class="fa fa-download"></i> Admin Invoice</a><br><br>
	<a target="_blank" href="<?php echo base_url(); ?>admin/casted_silver_sales_download_customer?id=<?php echo $orow['id']; ?>" class="btn btn-sm btn-success"><i class="fa fa-download"></i> Customer Invoice</a><br><br>
	<a target="_blank" href="<?php echo base_url(); ?>admin/casted_silver_sales_download_pickup?id=<?php echo $orow['id']; ?>" class="btn btn-sm btn-success"><i class="fa fa-download"></i> Pickup Invoice</a>
	</td>
	</tr>
	<?php }  ?>
	</tbody>
