		...
		<script>
			$(document).ready(function(){	
				...
				type: "POST",    
				dataType: "html",    
				url: "<?php echo site_url(); ?>admin/casted_gold_sales_ajax",    
				...
				e.preventDefault();		
					...
					$.post({
					type: "post",
					url:"<?php echo base_url(); ?>admin/casted_gold_sales_update",
					data:data,
					processData: false,
					contentType: false,
				...
				e.preventDefault();		
					...
					$.post({
					type: "post",
					url:"<?php echo base_url(); ?>admin/casted_gold_sales_cancel",
					data:data,
					processData: false,
					contentType: false,
					success:function(result)
				...
				<div class="table-responsive">
					...
					<?php 
						if($row['order_status']=='0'){
							...
							$end_time = date("h:i:s",strtotime("+".$home_content['casted_gold_order_time']." minutes", strtotime($row['order_date_time'])));			
					...
					?>
					<?php if($row['qr_code']!=''){ ?>
					<a target="_blank" href="<?php echo base_url(); ?>admin/casted_gold_sales_download_admin?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-success"><i class="fa fa-download"></i> Admin Invoice</a><br><br>
					<a target="_blank" href="<?php echo base_url(); ?>admin/casted_gold_sales_download_customer?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-success"><i class="fa fa-download"></i> Customer Invoice</a><br><br>
					<a target="_blank" href="<?php echo base_url(); ?>admin/casted_gold_sales_download_pickup?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-success"><i class="fa fa-download"></i> Pickup Invoice</a>
					<?php } ?>
					</td>
					<td>
					...
					<td>
						...
						<div style="display:flex;">
							...
							<div>
								...
								<div><b>Gold No's :</b> <?php echo $row['gold_nos']; ?></div>			
						...
						<a href="javascript:void(0)" onclick="openCancel(<?php echo $row['id']; ?>,'<?php echo $row['total_weight']*$home_content['casted_gold_deposit']; ?>')" class="btn btn-danger text-white">Cancel</a>
						<?php } ?>
					</td>
					</tr>
					<?php }}  ?>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
			...
			<div class="form-group">
				<label>gold nos<span class="text-danger">*</span></label>
				<input type="text" class="form-control" id="gold_nos" name="gold_nos" placeholder="Enter gold nos" required>
			</div>
			<div class="form-group">
