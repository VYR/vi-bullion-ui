...
<form id="search_form" method="post">
  ...
  <label for="email">Search:</label>
        <button type="submit" id="submit_id" class="btn btn-block silver-btn">SEARCH</button> 
      </div>
   </div>
</form>
<div id="orders_div">
...
{
	location.href="<?php echo site_url(); ?>casted-gold-dashboard";
}
</script>  
<script>
	$(document).ready(function(){
		...
		type: "POST",    
		dataType: "html",    
		url: "<?php echo site_url(); ?>casted_silver_dashboard_check",    
