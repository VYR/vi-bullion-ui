	...
	<form id="submit_form" method="post">
		...
		<div class="row register-form">
			...
			<div class="col-md-4 mb-3">
				...
				<button type="submit" id="submit_btn" class="btn abt-btn">Submit</button> 
			</div>
		</div>
	</form>	
</div>
...
<script>	
	...
	$(document).ready(function(){			
		$("#submit_form").on("submit", function(e){
			...
			type: "POST",    
			dataType: "html",    
			url:"<?php echo base_url(); ?>casted_gold_pickup_ajax",
			data: $("#submit_form").serialize()})
			.done(function(data) {
				location.href="<?php echo site_url(); ?>casted-gold-cart";
			});	
		});	
	});		
</script>