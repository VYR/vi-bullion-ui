	...
	<div class="table-responsive">
		<table class="table table-bordered">
			...
			<tbody>	
				...
				?>
				<tr class="<?php if($qty>0){ echo 'nbg3'; } ?> text-white">
	...
	<div class="text-center">	
		<?php 
			$deposit=$total_weight*$home_content['casted_silver_deposit'];
			$available_grams=$urecord['deposit_amount']/$home_content['casted_silver_deposit'];
			if($sub_total>0 && $urecord['deposit_amount']>=$deposit){
		?>	
		<a href="<?php echo site_url(); ?>casted-silver-checkout" class="btn silver-btn">Book Now</a> 
		<?php }else{ ?>	
