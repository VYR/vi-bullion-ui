...
<div class="border nbr3 rounded p-3">
	...
	<form role="form" id="submit_form" method="post" enctype="multipart/form-data">
		<div class="row" >
			...
			<h6><b>How much silver do you need per month</b></h6>
			<div class="row">
			<div class="col-6">
			...
			<div class="col-md-12 form-group text-center">
				...
				<button type="submit" id="submit_id" class="btn silver-btn">Submit</button>
				<div id="msg"></div>
			</div>
			<div class="col-md-12 text-center">
			<a href="<?php echo site_url(); ?>casted-silver-login" class="ncolor3">Login Now?</a>
			</div>
		</div>
	</form>
</div>
	...
	$(document).ready(function(){			
		$("#submit_form").on("submit", function(e){
			...
			if(promoter_name==''){
				...
				$.post({
					type: "post",
					url:"<?php echo base_url(); ?>casted_silver_register_ajax",
					data:data,
					processData: false,
					contentType: false,
					...
					{		
						...
						if(jsondata['status']==1)
						{
							...
							$("#submit_form")[0].reset();
							setTimeout(function(){ window.location.href="<?php echo site_url(); ?>casted-silver-login"; }, 1000);
						}
						else
						{
