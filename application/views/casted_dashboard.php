...
<h1 class="text-center upperCase">Dashboard</h1>
<form id="search_form" method="post">
  ...
  <label for="email">Search:</label>
        <button type="submit" id="submit_id" class="btn btn-block btn-success">SEARCH</button> 
      </div>
   </div>
</form>
<div id="orders_div">
...
<script>
	$(document).ready(function(){
		...
		type: "POST",    
		dataType: "html",    
		url: "<?php echo site_url(); ?>casted_dashboard_check",    
