		...
		<a href="<?php echo base_url(); ?>" class="btn buy-btn"><i class="fa fa-angle-left mr-2" aria-hidden="true"></i>Continue Shopping</a>
		</div>
		<div class="col-md-3 offset-md-5 pt-2">
		<div class="input-group mb-3 mr-3">
		<input type="text" class="form-control" placeholder="Enter Coupon Code" id="coupon_code">
		<div class="input-group-append">
		<button type="button" class="btn buy-btn" onclick="addCoupon()">Apply</button>
		</div>
		</div>
		</div>
		</div>
		...
		<div class="col-md-12 p-4 text-center"><button type="button" class="btn buy-btn">Place Order<i class="fa fa-angle-right  ml-1" aria-hidden="true"></i></button></div>
		</div>
		</form>
		<?php }else{  ?>	
