	...
	<div class="row">	
		...
		<div class="col-md-3 form-group text-white">
			...
			<?php 
				$discount=0;
				if(!empty($promoter)){
					$discount=$total_weight*$home_content['casted_gold_discount'];
				}
		...
		<div class="col-md-3 form-group"><br>	
			<button type="button" class="btn abt-btn" onclick="showSubmit()">Confirm</button> 		
		</div>				
	</div>			
	<div class="text-center mt-3 text-white" id="submit_div" style="display:none;">	
		...
		<button type="button" id="submit_btn" class="btn abt-btn" onclick="submitOrder()">Submit</button> 	
	</div>	